...
rule varcall_clairs_to:
    ...
    shell:
        ...
        mv {params.outdir}/{wildcards.sample}_{wildcards.type}_snv.vcf.gz.tbi {output.snv}.tbi
        mv {params.outdir}/{wildcards.sample}_{wildcards.type}_indel.vcf.gz {output.indel}
        mv {params.outdir}/{wildcards.sample}_{wildcards.type}_indel.vcf.gz.tbi {output.indel}.tbi
        """
