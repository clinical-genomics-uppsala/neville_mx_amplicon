...
|-------------|---------|-------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| dorado      | 1.1.0   | `docker://ontresearch/dorado:latest`                        | Used in multiple steps: basecalling, demultiplexing, trimming, alignment. The basecalling model used in Dorado must be downloaded separately.                     |
